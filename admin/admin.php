            ...
            <div class="row align-items-start">
                ...
                <div class="col">
                    ...
                    <form class="d-flex" method="GET" action="admin.php">
                        ...
                        <button class="btn btn-outline-secondary" type="submit" name="search_admin" value="search">Cari</button>
                    </form>
                    <br>
                </div>
            </div>
            ...
            <table class="table table-striped table-sm">
                <thead>
                    <tr>
                        ...
                        <th scope="col">
                        <th scope="col">
                            <button type="button" class="btn btn-outline-primary "><a style="text-decoration: none; color:black;" href="admin.php?add=1"> &nbsp;&nbsp;Tambah&nbsp;&nbsp;</a></button>
                        </th>
                        </th>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            ?>
                                <td>
                                    <button type="button" class="btn pull-left btn-outline-danger"><a style="text-decoration: none; color:black;" href="admin.php?delete=<?php echo $data[$i]['admin_id'] ?>">Hapus</a></button>
                                </td>
                            <?php
                            } else {
                            ?>

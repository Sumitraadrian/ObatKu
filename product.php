...
<body>
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <a href="store.php">Toko</a> <span class="mx-2 mb-0">/</span> <strong class="text-black"><?php echo $data[0]['item_title'] ?></strong></div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-5 mr-auto">
            ...
            <img src="images/<?php echo rawurlencode($data[0]['item_image']); ?>" alt="Image" class="img-fluid p-5">
            </div>
          </div>
          <div class="col-md-6">
            ...
            <p><strong class="text-primary h4">Rp <?php echo number_format($data[0]['item_price'], 0, ',', '.') ?></strong></p>
            <?php
            ...
            ?>
              ...
              <form action="product.php" method="GET">
                <div class="mb-5">
                  ...
                  <br>
                  <button name="cart" type="submit" class="btn btn-primary btn-lg">Tambah Ke Keranjang</button>
              </form>
            <?php
            } else {
            ?>
              ...
              <form action="product.php" method="GET">
                <div class="mb-5">
                  ...
                  <br>
                  <p style="color: black;"><a disabled type="submit" value="" class="buy-now btn btn-sm height-auto px-4 py-3 btn-primary">Tambah Ke Keranjang</a></p>
          ...
          <div class="mt-5">
            <ul class="nav nav-pills mb-3 custom-pill" id="pills-tab" role="tablist">
              <li class="nav-item">
                <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">Informasi Pengiriman</a>
              </li>
              <li class="nav-item">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <?php if ($data[0]['item_price'] >= 200) {
                        echo "<td class='bg-light'>Gratis</td>";
                      } else {
                        echo "<td class='bg-light'>Rp 40</td>";
                      }
                      ?>
                    </tr>
                </table>
